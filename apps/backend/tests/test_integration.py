...
def test_full_aircraft_pipeline(mock_get):
  ...
  # We provide one valid plane (on approach to LHR) and one invalid plane (missing coords)
  ...
  mock_response.json.return_value = {
    ...
    "states": [
      ...
      ["111111", "BAW1    ", "UK", 0, 0, -0.5, 51.47, 800.0, False, 100.0, 92.0, -3.0, None, 800.0, "1234", False, 0],
      # Invalid: Missing latitude/longitude (should be dropped by parser)
      ["222222", "GHOST   ", "UK", 0, 0, None, None, 1000.0, False, 100.0, 0.0, 0.0, None, 1000.0, "1234", False, 0]
    ]
  }
